...
namespace ErgaMauter.Content.Items.Weapons
{
    public class FlamingFury : ModItem
    {
        ...
        {
            // DisplayName.SetDefault("Example Broadsword"); // No longer needed in current tModLoader versions
            /* Tooltip.SetDefault("This is a modded broadsword")  // No longer needed, use .hjson files for localization
               See: https://github.com/tModLoader/tModLoader/wiki/Localization */
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 0f;                       // Speed of projectile if applicable
